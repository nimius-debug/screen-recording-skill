#!/usr/bin/env node
// Optional SessionStart hook: make a fresh Claude Code session ready to record
// without a manual install step. Idempotent — a fast no-op once node_modules exists.
